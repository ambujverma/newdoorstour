(function ($) {
  ...
  $(".pxp-hero-props-carousel-2-right").on("slide.bs.carousel", function (
    carousel
  ) {
  ...
  $(".pxp-hero-props-carousel-2-right").on("slid.bs.carousel", function (
    carousel
  ) {
    var tickerPos = carousel.to * 13;
  ...
  $(".pxp-blog-posts-carousel-1-img").on("slide.bs.carousel", function (
    carousel
  ) {
    if (carousel.direction == "left") {
